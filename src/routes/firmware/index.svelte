...
<div class="page">
  ...
  <ul>
    <li>Drag and drop <code>CURRENT.uf2</code> to the drive. Make sure the file is called <code>CURRENT.uf2</code> - <b>do not rename.</b></li>
  ...
  <ul>
    ...
    <li>Drag and drop the <code>CURRENT.uf2</code> file onto the Plinky USB Drive</li>
  </ul>
